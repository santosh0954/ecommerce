...
<div class="container-fluid bg-white border border-muted rounded py-3">
  <div class="row">
    <div class="col-4">
      ...
      <img src="../../images/new-launch/samsung-galaxy-a30.jpeg" alt=" samsung a30">
</div>
        <div class="card-footer text-center">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="add">
              <input type="hidden" value="samsung a30" name="title">
              <input type="hidden" value="images/new-launch/samsung-galaxy-a30.jpeg" name="img-src">
              <input type="hidden" value="16999" name="o-price">
              <input type="hidden" value="14999" name="d-price">
    ...
    <div class="col-8 p-5">
        <h2>Samsung galaxy a30</h2>
        <p>&#8377;14999 <s class="text-muted">&#8377;16999</s></p>
