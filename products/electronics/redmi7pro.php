...
<div class="container-fluid bg-white border border-muted rounded py-3">
  <div class="row">
    <div class="col-4">
      ...
      <img src="../../images/new-launch/mi-redmi-note-7-pro.jpeg" alt=" redmi">
</div>
        <div class="card-footer text-center">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="add">
              <input type="hidden" value="redmi 7 pro" name="title">
              <input type="hidden" value="images/new-launch/mi-redmi-note-7-pro.jpeg" name="img-src">
              <input type="hidden" value="14999" name="o-price">
              <input type="hidden" value="13999" name="d-price">
    ...
    <div class="col-8 p-5">
        <h2>Redmi 7 Pro</h2>
        <p>&#8377;13999 <s class="text-muted">&#8377;14999</s></p>
