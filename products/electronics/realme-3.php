...
<div class="container-fluid bg-white border border-muted rounded py-3">
  <div class="row">
    <div class="col-4">
      ...
      <img src="../../images/new-launch/realme-3.jpeg" alt=" realme">
</div>
        <div class="card-footer text-center">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="add">
              <input type="hidden" value="realme 3" name="title">
              <input type="hidden" value="images/new-launch/realme-3.jpeg" name="img-src">
