...
<div class="container-fluid bg-white border border-muted rounded py-3">
  <div class="row">
    <div class="col-4">
      ...
      <img src="../../images/new-launch/mi-redmi-6-pro.jpeg" alt=" redmi">
</div>
        <div class="card-footer text-center">
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="add">
              <input type="hidden" value="redmi 6 pro" name="title">
              <input type="hidden" value="images/new-launch/mi-redmi-6-pro.jpeg" name="img-src">
              <input type="hidden" value="13999" name="o-price">
              <input type="hidden" value="12999" name="d-price">
    ...
    <div class="col-8 px-5">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Redmi note 6 pro</li>
        </ul>
        <h2>Redmi 6 Pro</h2>
        <p>&#8377;12999 <s class="text-muted">&#8377;13999</s></p>
