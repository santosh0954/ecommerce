...
<div class="container-fluid bg-white border border-muted rounded py-3">
  <div class="row">
    <div class="col-4">
      ...
      <img src="../../images/new-launch/mi-redmi-note-7.jpeg" alt=" redmi">
</div>
        <div class="card-footer text-center">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="add">
              <input type="hidden" value="redmi 7" name="title">
              <input type="hidden" value="images/new-launch/mi-redmi-note-7.jpeg" name="img-src">
              <input type="hidden" value="10999" name="o-price">
              <input type="hidden" value="9999" name="d-price">
    ...
    <div class="col-8 p-5">
        <h2>Redmi Note 7</h2>
        <p>&#8377;9999 <s class="text-muted">&#8377;10999</s></p>
